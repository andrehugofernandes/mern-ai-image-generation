...
//         onClick={handleClick}
//       />
//       <div className="group-hover:flex flex-col max-h-[94.5%] hidden absolute bottom-0 left-0 right-0 bg-[#10131fe8] m-2 p-4 rounded-md">
//         <p className="text-white text-md overflow-y-auto prompt">{prompt}</p>
...
//             </button>
//             <img
//               className="w-full h-[76vh] object-cover rounded-lg"
//               src={photo}
//               alt={prompt}
//             />
...
const Card = ({ _id, name, prompt, photo }) => {
  ...
  return (
    <div className="rounded-xl group relative shadow-card hover:shadow-cardhover card">
      ...
      {showPopup && (
        <div className="fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center z-10 bg-[#003476e8]">
