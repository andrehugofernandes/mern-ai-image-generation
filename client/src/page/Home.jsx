...
const Home = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-[#222328] text-[32px]">GERADOR DE IMAGENS VIA PROMPT</h1>
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">
          Navegue através de uma coleção de imagens imaginativas e estonteantes criadas pelo DALL-E AI.
        </p>
      </div>
